...
const Navbar = () => {
    ...
    const { getCartCount, user, logout, token } = useContext(ShopContext);
        ...
        <div className='flex items-center justify-between py-5 font-medium'>
                ...
                <div className='relative' ref={dropdownRef}>
                    ...
                    {profileOpen && (
                        <div className='absolute right-0 mt-2 z-50'>
                            <div className='flex flex-col text-center gap-2 w-36 py-3 px-5 bg-white/30 backdrop-blur-sm text-gray-900 rounded shadow-md'>
                                {token ? (
                                    <>
                                        <p
            ...
            <div className={`fixed top-0 right-0 bottom-0 overflow-hidden bg-white transition-all z-50 ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={() => setVisible(false)} className='py-4 pl-6 border-b border-gray-100 delius-unicase-regular text-gray-700 hover:bg-gray-50' to='/'>
                        HOME
                    </NavLink>
                    <NavLink onClick={() => setVisible(false)} className='py-4 pl-6 border-b border-gray-100 delius-unicase-regular text-gray-700 hover:bg-gray-50' to='/catalogue'>
                        CATALOGUE
                    </NavLink>
                    <NavLink onClick={() => setVisible(false)} className='py-4 pl-6 border-b border-gray-100 delius-unicase-regular text-gray-700 hover:bg-gray-50' to='/custom'>
                        CUSTOM
                    </NavLink>
                    <NavLink onClick={() => setVisible(false)} className='py-4 pl-6 border-b border-gray-100 delius-unicase-regular text-gray-700 hover:bg-gray-50' to='/about'>
                        ABOUT
                    </NavLink>
                </div>
            </div>
