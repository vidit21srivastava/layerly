  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${backendURL}/api/payment/phonepe/initiate`,
        orderData,
        {
          headers: { token },
        },
        ...
        <div className="flex-1 lg:flex-[2] max-w-none lg:max-w-2xl">
          ...
          <form className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                className="border border-gray-300 rounded-lg py-2.5 px-3.5 w-full focus:border-gray-500 focus:outline-none"
                type="text"
                name="firstName"
            ...
            <textarea
              ...
              onChange={handleInputChange}
              placeholder="Instruction for Custom Order (if any)"
            />
          </form>
        </div>
            ...
            <div className="mt-4">
              <div className="flex flex-col md:flex-row md:items-center bg-white border-2 border-purple-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow gap-1 md:gap-4">
                ...
                <div className="flex items-center gap-3 mb-4 md:mb-0 md:flex-shrink-0">
                  <img className="w-8 h-8" src={assets.PhonePe} alt="PhonePe" />
                  <div>
                ...
                <button
                  ...
                  disabled={loading}
                  className={`w-full md:flex-1 py-4 px-6 rounded-xl font-bold text-base transition-all duration-200 flex items-center justify-center gap-2 ${
                    loading
