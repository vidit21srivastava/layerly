...
const Custom = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${backendURL}/api/custom/quote`, payload, {
        headers,
      });
      if (res.data.success) {
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                  ...
                  <p className="text-xs text-gray-600 mt-2">
                    Make sure the file is publicly accessible. Ensure “Anyone
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm sticky top-4">
                  ...
                  {viewerProxyUrl ? (
                    ...
                    <div className="w-full h-[360px] flex items-center justify-center text-gray-500">
                      <div className="text-center">
                        <p className="text-sm">
                          Paste a public STL file Google Drive link to preview
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <div className="mt-4 text-sm text-gray-600">
                  <p className="mb-2">
                    <strong>Tip:</strong> You can Rotate/Zoom-in/Zoom-out the
                    model above for better preview.
                  </p>
                </div>
              </div>
            </div>
