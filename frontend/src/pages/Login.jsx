...
const Login = () => {
    ...
    return (
        <div className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-700 border-t pt-10'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col w-full gap-4'>
                {currentState === 'Sign Up' && (
                    <input
                        ...
                        className='w-full px-3 py-2 border border-gray-800 rounded focus:outline-none focus:border-gray-600'
                ...
                <div className='relative'>
                    <input
                        ...
                        onChange={handleInputChange}
                        className='w-full px-3 py-2 pr-10 border border-gray-800 rounded focus:outline-none focus:border-gray-600'
