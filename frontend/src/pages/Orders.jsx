                    ...
                    <div className="flex flex-col md:items-center md:flex-row gap-6 md:gap-8">
                      ...
                      <div className="flex-1 md:flex-initial md:w-48 flex flex-col gap-3 justify-start">
                        ...
                        <button
                          ...
                          className="w-full border border-gray-300 text-gray-700 py-2.5 px-4 rounded-lg text-sm font-bold hover:bg-gray-50 transition-colors duration-200"
                        >
                          Download Invoice
                        </button>
                      </div>
