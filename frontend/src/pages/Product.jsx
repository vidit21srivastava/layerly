...
const Product = () => {
  ...
  const currentImage =
    productData?.imagesByColor?.[selectedColor] ||
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      {productData.availableColors.map((color, index) => {
                        const colorImage =
                          productData?.imagesByColor?.[color] ||
                        ...
                        return (
                          <div
                            ...
                            className={`w-16 h-16 sm:w-20 sm:h-20 rounded-lg border-2 cursor-pointer transition-all duration-200 overflow-hidden ${
                              selectedColor === color
              ...
              {!isInCart ? (
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:items-center">
                  <div className="flex items-center justify-between sm:justify-start bg-gray-100 rounded-lg p-3 sm:p-2 max-w-[200px] mx-auto sm:mx-0 sm:flex-shrink-0 sm:w-auto">
                    ...
                    >
                      <span className="text-gray-600 font-medium text-xl leading-none">
                        −
                      </span>
                    </button>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-xl bg-white shadow-sm">
                ...
                {openIndex === 2 && (
                  <div className="px-5 pb-4 text-gray-600">
                    <p>
                      To cancel your order, you must call us at +91 96648 51323
                      (as listed in the Contact section). If order processing
                      has not yet begun, we may provide a refund. For refunds,
                      please email us your bank account or UPI details along
                      with your Order ID.
                    </p>
                  </div>
                )}
              ...
              <div className="border border-gray-200 rounded-xl bg-white shadow-sm">
                ...
                {openIndex === 3 && (
                  <div className="px-5 pb-4 text-gray-600">
                    <p>
                      Order processing begins within 24–48 hours of order
                      placement. You will receive an email notification when
                      processing starts.
                    </p>
                  </div>
                )}
              ...
              <div className="border border-gray-200 rounded-xl bg-white shadow-sm">
                ...
                {openIndex === 4 && (
                  <div className="px-5 pb-4 text-gray-600">
                    <p>
                      At checkout, enter the text to be printed in the Info
                      field. For multiple items, format it as "Product_Name -
                      Text_to_be_printed".
                    </p>
                  </div>
                )}
